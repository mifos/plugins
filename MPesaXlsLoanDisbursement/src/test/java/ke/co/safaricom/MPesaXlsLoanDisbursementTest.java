...
public class MPesaXlsLoanDisbursementTest {
    TransactionImport transactionImport;
    MPesaXlsLoanDisbursement concreteImporter;
    @Mock
    ...
    public void canParseTextBasedDate() throws Exception {
        ...
        Date expected = new SimpleDateFormat(MPesaXlsLoanDisbursement.DATE_FORMAT).parse(fakeDateString);
